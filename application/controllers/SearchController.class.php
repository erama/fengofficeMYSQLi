...
class SearchController extends ApplicationController {
	...
	function search() {
		...
		$search_string = mysqli_real_escape_string($search_for, DB::connection()->getLink());
		...
		if($_POST) {
			...
			foreach($conditions as $condition){
				...
				if($condition['field_type'] == 'boolean'){
					...
					$value = mysqli_real_escape_string($condValue, DB::connection()->getLink());
				}			
				$condition_condition = mysqli_real_escape_string(array_var($condition, 'condition'), DB::connection()->getLink());
				$condition_field_name = mysqli_real_escape_string(array_var($condition, 'field_name'), DB::connection()->getLink());
				$conditionLocal = "like";
...
//		tpl_assign('allowed_columns', $this->get_allowed_columns($selected_type));
	...
	function general_search() {
		...
		$search_string = mysqli_real_escape_string($search_string, DB::connection()->getLink());
