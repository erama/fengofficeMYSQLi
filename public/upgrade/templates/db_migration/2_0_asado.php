...
<?php
echo "\n";
include dirname(__FILE__)."/../../../install/installation/templates/sql/mysqli_schema.php";
echo "\n";
include dirname(__FILE__)."/../../../install/installation/templates/sql/mysqli_initial_data.php";
echo "\n";
?>
